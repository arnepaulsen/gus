...
public class BeanFieldSelect extends BeanWebField {
	...
	public BeanFieldSelect(String fieldName, String defaultValue, String codeSet) {
		...
		super(fieldName);
		System.out.println ("STARTING BEANFIELDSELECT constructor   pattern 1 : " + fieldName);
	...
	public BeanFieldSelect(String fieldName, String defaultValue, String codeSet, boolean useAltCodeSet) {
		...
		super(fieldName);
		System.out.println (" STARTING BEANFIELDSELECT constructor   pattern 2" + fieldName);
		this.defaultStringValue = defaultValue;
		usingCodeSet = true;
		showPleaseSelect = true;
		codesetName = codeSet;
	...
	public BeanFieldSelect(String fieldName, String defaultValue, String codeSet_empty, String sql) {
		...
		super(fieldName);
		System.out.println("STARTING BEANFIELDSELECT constructor pattern 3 for " + fieldName);
		this.defaultStringValue = defaultValue;
		usingCodeSet = true;
		showPleaseSelect = true;
		codesetName = "SQL";
	...
	public BeanFieldSelect(String fieldName, Integer defaultValue, String codeSet) {
		...
		debug ("STARTING BEANFIELDSELECT constructor for pattern #4  for field " + fieldName);
	...
	public BeanFieldSelect(int column, String filterName, String ColumnName, String defaultValue, String listDefault,
		...
		System.out.println (" STARTING BEANFIELDSELECT constructor  pattern 5 for field " + filterName);
		this.defaultStringValue = defaultValue;
		codesetName = codeSet;
		showPleaseSelect = true;
		promptText = prompt;
	...
	public BeanFieldSelect(int column, String filterName, String ColumnName, String defaultValue, String listDefault,
		...
		super(filterName, ColumnName);
		System.out.println (" STARTING BEANFIELDSELECT constructor   pattern 6 for filter " + filterName);
		this.defaultStringValue = defaultValue;
		codesetName = "SQL";
		this.usingQuery = true;
	...
	public BeanFieldSelect(int column, String filterName, String ColumnName, Integer defaultInteger,
		...
		super(filterName, ColumnName);
		debug(" .. initialize BeanFieldSelect constructor pattern 7 for " + filterName);
	...
	public BeanFieldSelect(int column, String filterName, String ColumnName, Integer defaultInteger,
		...
		System.out.println (" .. initialize BeanFieldSelect pattern 8 for " + filterName);
	...
	public BeanFieldSelect(int column, String filterName, String ColumnName, Integer defaultInteger,
		...
		System.out.println (" .. initialize BeanFieldSelect pattern 9 for " + filterName);
