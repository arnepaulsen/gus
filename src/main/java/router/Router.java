...
public class Router extends HttpServlet implements javax.servlet.Servlet {
	...
	private synchronized void Redirect(HttpServletRequest req,
		...
		String l2 = "<HTML><HEAD>";
		String l3 = "<META http-equiv=\"Refresh\" content=\"15; URL=http://arnepaulsenjr.com:8088/gus/Router\">";
		String l4 = "<META name=\"GENERATOR\" content=\"IBM WebSphere Studio\"></HEAD><BODY>";
		String l5 = "The PMO Tool is now has moved to an A&I production server at <a href=\"http://arnepaulsenjr.com:8088/gus/Router\">http://arnepaulsenjr.com:8088/gus/Router</a>";
